...
if "yellow" in which_door:
  print("You are in the labratory")
...
print("You are facing a keyboard")
password_or_another_room = input("Do you want to guess the passcode or enter another room? ").lower()